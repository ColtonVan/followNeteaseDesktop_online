	...
	["chunk-1949512d"],
	{
		"533e": function (e, t, n) {
			...
			var o = { class: "px-5 py-4" },
				...
				s = { class: "dateText fw-bold position-absolute start-50 fs-1 translate-middle" },
				d = Object(c["i"])(
					"div",
					{ class: "ms-5 d-flex flex-column justify-content-center" },
					[
						Object(c["i"])("div", { class: "fs-1" }, "每日歌曲推荐"),
						Object(c["i"])("div", { class: "text-muted" }, "根据你的音乐口味生成，每天6:00更新"),
					],
					-1
				),
			...
			var m = i(function (e, t, n, m, v, g) {
							...
							[
								Object(c["i"])("div", o, [
									Object(c["i"])("div", a, [
										Object(c["i"])("div", l, [
											Object(c["i"])("div", r, [
												Object(c["i"])(p, { width: "90", height: "90", color: e.calendarColor }, null, 8, ["color"]),
												Object(c["i"])("div", s, Object(c["E"])(new e.window.Date().getDate()), 1),
											]),
											d,
										]),
										Object(c["i"])("div", u, [
											Object(c["i"])(h, { musicList: e.dailySongs }, null, 8, ["musicList"]),
											Object(c["i"])(
												"div",
												{
													onClick:
										...
										Object(c["i"])("div", j, [
											Object(c["i"])(y, { columns: e.columns, dataSource: e.dailySongs }, null, 8, ["columns", "dataSource"]),
										]),
									]),
								]),
								Object(c["i"])(
												...
												Object(c["i"])("div", f, [
													...
													Object(c["f"])(
														...
														Object(c["z"])(e.songsUrlObjArr, function (t, n) {
															return (
																Object(c["t"])(),
																Object(c["f"])("div", { key: n, class: "d-flex align-items-center cursor-pointer" }, [
																	Object(c["O"])(
																		Object(c["i"])(
																			"input",
																			{
																			...
																			null,
																			8,
																			["name", "id", "onUpdate:modelValue", "checked"]
																		),
																		[[c["I"], t.checked]]
																	),
																	Object(c["i"])(
													...
													Object(c["i"])(
														"div",
														{
															onClick:
																t[2] ||
																(t[2] = function () {
																	return e.confirmDownload && e.confirmDownload.apply(e, arguments);
																}),
				...
				p = n("2909"),
				h = n("1da1"),
				w = (n("96cf"), n("a15b"), n("b0c0"), n("99af"), n("4d90"), n("d3b7"), n("7db0"), n("3ca3"), n("ddb0"), n("54ba")),
				y = n("17b9"),
				k = n("d4c0"),
				x = n("5502"),
				S = n("3c08"),
				...
				M = Object(c["j"])({
					setup: function () {
						var e = Object(x["b"])(),
							...
							n = Object(c["x"])({
								...
								defaultListName: "每日歌曲推荐("
									...
									.concat(String(new Date().getMonth() + 1).padStart(2, "0"), ".")
														...
														while (1)
															switch ((i.prev = i.next)) {
																case 0:
																	...
																	return (i.next = 3), Object(k["b"])(o.data.dailySongs);
																case 3:
																	(n.dailySongs = i.sent),
																		(r = t.query.immediate),
																		r &&
																			...
																			void 0 !== l &&
																			l.length &&
																			(e.commit("changeCurrentMusicDetail", o.data.dailySongs[0]),
																			e.commit(
																				"changeCurrentPlayList",
																				[].concat(
																					Object(p["a"])(JSON.parse(JSON.stringify(o.data.dailySongs))),
																					Object(p["a"])(e.state.currentPlayList)
																				)
																			),
																			e.dispatch("getCurrentMusicUrlInfo", { id: o.data.dailySongs[0].id })),
																		c(o);
																case 7:
																case "end":
																	return i.stop();
						...
						var l = Object(c["d"])(function () {
								return "primaryTheme" === e.getters.getTheme ? "#ec4141" : "darkTheme" === e.getters.getTheme ? "#212529" : "#50c475";
							}),
							r = function (e) {
								(n.currentMusicObj = e),
									Object(w["g"])(e.id).then(function (e) {
										200 === e.code &&
											(1 === e.data.length
												? (n.songsUrlObjArr = e.data.map(function (e) {
														return Object(g["a"])(Object(g["a"])({}, e), {}, { checked: !0 });
												  }))
												: (n.songsUrlObjArr = e.data.map(function (e) {
														return Object(g["a"])(Object(g["a"])({}, e), {}, { checked: !1 });
												  })),
							...
							s = function () {
								...
								e && Object(S["c"])(e.url, n.currentMusicObj.name);
							},
							d = function (e, t) {
								Object(w["h"])({ id: e.id, like: t }).then(function (e) {
									200 === e.code &&
										Promise.all([i(), o()]).then(function (e) {
											var c = Object(v["a"])(e, 2),
												i = c[0],
												o = c[1];
											200 === i.code && 200 === o.code && n.commonToast.success(t ? "已添加到我喜欢的音乐" : "取消喜欢成功");
										});
								});
							};
						return Object(g["a"])(
...
//# sourceMappingURL=chunk-1949512d.b9131492.js.map
